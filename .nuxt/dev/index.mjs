...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file://C:/projek/nuxt-event/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/projek/nuxt-event/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///C:/projek/nuxt-event/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///C:/projek/nuxt-event/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://C:/projek/nuxt-event/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/projek/nuxt-event/node_modules/unhead/dist/server.mjs';
import { isVNode, isRef, toValue } from 'file://C:/projek/nuxt-event/node_modules/vue/index.mjs';
import { DeprecationsPlugin } from 'file://C:/projek/nuxt-event/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/projek/nuxt-event/node_modules/unhead/dist/plugins.mjs';
import { klona } from 'file://C:/projek/nuxt-event/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/projek/nuxt-event/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/projek/nuxt-event/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/projek/nuxt-event/node_modules/scule/dist/index.mjs';
import { defineDiagnostics, createConsoleReporter } from 'file://C:/projek/nuxt-event/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://C:/projek/nuxt-event/node_modules/nostics/dist/formatters/ansi.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/projek/nuxt-event/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file://C:/projek/nuxt-event/node_modules/vue/server-renderer/index.mjs';
import { stringify, uneval } from 'file://C:/projek/nuxt-event/node_modules/devalue/index.js';
import { createHooks } from 'file://C:/projek/nuxt-event/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/projek/nuxt-event/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/projek/nuxt-event/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/projek/nuxt-event/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/projek/nuxt-event/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/projek/nuxt-event/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/projek/nuxt-event/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/projek/nuxt-event/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/projek/nuxt-event/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/projek/nuxt-event/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/projek/nuxt-event/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/projek/nuxt-event/node_modules/@nuxt/nitro-server/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/projek/nuxt-event/node_modules/errx/dist/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/projek/nuxt-event/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/projek/nuxt-event/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/projek/nuxt-event/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/projek/nuxt-event/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/projek/nuxt-event","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/projek/nuxt-event/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/projek/nuxt-event/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/projek/nuxt-event/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/projek/nuxt-event/.data/kv"}));
...
const _DnKRicVm2f1XtRrWNNbDD6bB234fNuDR2DEFBQgNsdc = (function(nitro) {
...
const rootDir = "C:/projek/nuxt-event";
...
const plugins = [
  _DnKRicVm2f1XtRrWNNbDD6bB234fNuDR2DEFBQgNsdc,
...
const _lazy_FuRilh = () => Promise.resolve().then(function () { return renderer; });
