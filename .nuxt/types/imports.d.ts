...
declare global {
  ...
  const useMediaUrl: typeof import('../../app/composables/useMediaUrl').useMediaUrl
...
declare global {
  ...
  // @ts-ignore
  export type { EmailNotificationTemplate, EmailDeliveryItem, EmailPreview, EmailTestResult, EmailAccountPreference, EmailTemplatePayload } from '../../app/composables/useEmailNotifications'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useMediaUrl: UnwrapRef<typeof import('../../app/composables/useMediaUrl')['useMediaUrl']>
