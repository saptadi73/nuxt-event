...
import { i as injectHead$1, V as VueResolver, p as publicAssetsURL, b as baseURL, h as headSymbol } from '../routes/renderer.mjs';
...
var namedMiddleware = { auth: () => import('../build/auth-MythtwWY.mjs') };
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	...
	},
	{
		name: "auth-login",
		path: "/auth/login",
		component: () => import('../build/login-C5Jz2hv_.mjs')
	},
	{
	...
	},
	{
		...
		meta: { "middleware": "auth" },
		component: () => import('../build/invoice-j_azRupb.mjs')
	},
	{
		name: "dashboard-payment",
		path: "/dashboard/payment",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-fBJoEYyN.mjs')
	},
	{
		name: "dashboard-payment-status",
		path: "/dashboard/payment-status",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-status-CbezsKsg.mjs')
	},
	{
	...
	},
	{
		...
		meta: { "middleware": "auth" },
		component: () => import('../build/schedule-D3VrIUGJ.mjs')
	},
	{
		name: "dashboard-ticket",
		path: "/dashboard/ticket",
		meta: { "middleware": "auth" },
		component: () => import('../build/ticket-CB9VfhXj.mjs')
	},
	{
		name: "about",
		path: "/about",
		component: () => import('../build/about-Cx6XuAif.mjs')
	},
	{
	...
	},
	{
		...
		path: "/dashboard",
		meta: { "middleware": "auth" },
		component: () => import('../build/dashboard-BV-Id95C.mjs')
	},
	{
		name: "directory-consent",
		path: "/directory-consent",
		component: () => import('../build/directory-consent-C_2Q7PaU.mjs')
	},
	{
		name: "faq",
		path: "/faq",
	...
	},
	{
		name: "program",
		path: "/program",
		component: () => import('../build/program-8coQTdFZ.mjs')
	},
	{
		name: "refund-policy",
		path: "/refund-policy",
	...
	},
	{
		...
		path: "/register",
		meta: { "middleware": "auth" },
		component: () => import('../build/register-Wt3zp1g4.mjs')
	},
	{
		name: "speakers",
		path: "/speakers",
	...
	},
	{
		name: "tickets",
		path: "/tickets",
		component: () => import('../build/tickets-C-zjnjSg.mjs')
	},
	{
		name: "workshops",
		path: "/workshops",
		component: () => import('../build/workshops-Cj_n_Q9s.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-8p5mlxv8.mjs')
	}
];
//#endregion
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_NuxtLink, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-cyan-400/30 bg-white/10 p-1 shadow-lg shadow-cyan-950/20"${_scopeId}><img${ssrRenderAttr("src", _virtual_public__2Fbranding_2Fai_asean_default)} alt="ASEAN AI for Education logo" class="h-full w-full object-contain"${_scopeId}></span><span class="hidden sm:block"${_scopeId}><span class="block whitespace-nowrap text-[10px] uppercase tracking-[0.35em] text-cyan-200/70"${_scopeId}>ASEAN Event Portal</span><span class="block whitespace-nowrap text-base font-semibold text-white"${_scopeId}>ASEAN AI for Education</span></span>`);
					else return [createVNode("span", { class: "flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-cyan-400/30 bg-white/10 p-1 shadow-lg shadow-cyan-950/20" }, [createVNode("img", {
						src: _virtual_public__2Fbranding_2Fai_asean_default,
						alt: "ASEAN AI for Education logo",
						class: "h-full w-full object-contain"
					})]), createVNode("span", { class: "hidden sm:block" }, [createVNode("span", { class: "block whitespace-nowrap text-[10px] uppercase tracking-[0.35em] text-cyan-200/70" }, "ASEAN Event Portal"), createVNode("span", { class: "block whitespace-nowrap text-base font-semibold text-white" }, "ASEAN AI for Education")])];
				}),
				_: 1
			}, _parent));
			...
			_push(ssrRenderComponent(_component_NuxtLink, { to: "/workshops" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Workshops`);
					else return [createTextVNode("Workshops")];
				}),
				_: 1
			}, _parent));
			...
			_push(`</div><div class="text-sm text-slate-400 md:text-right"><p>Information: info@aseanaiedu.com</p><p class="mt-1">Registration: registration@aseanaiedu.com</p><div class="mt-3 flex flex-wrap gap-4 md:justify-end">`);
			...
			_push(`</div></div></div><p class="border-t border-white/10 px-4 py-5 text-center text-xs text-slate-500">(c) 2026 ASEAN AI for Education Summit. All rights reserved.</p></footer></div>`);
		};
	}
});
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-Ce-YrUNI.mjs'));
...
export { NuxtLink as N, _virtual_public__2Fbranding_2Fai_asean_default as _, useSeoMeta$1 as a, useAsyncData as b, useNuxtApp as c, defineNuxtRouteMiddleware as d, useAuth as e, useRoute as f, useRuntimeConfig as g, useHead$1 as h, entry as i, navigateTo as n, useAuthStore as u };;globalThis.__timing__.logEnd('Load chunks/virtual/entry');
