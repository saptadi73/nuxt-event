...
import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, ref, customRef, inject, toRef, isRef, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, defineAsyncComponent, mergeProps, shallowRef, isReadonly, defineComponent, createElementBlock, cloneVNode, h, useSSRContext, isShallow, isReactive, toRaw, isVNode, createCommentVNode, watch, computed, withCtx, openBlock, createBlock, createTextVNode, toDisplayString, Suspense, resolveComponent, Fragment, toValue, nextTick, queuePostFlushCb } from 'vue';
import { $ as $fetch, m as klona, n as getRequestHeader, o as isEqual, p as setCookie, q as getCookie, v as deleteCookie, f as createError, w as hasProtocol, i as joinURL, x as withQuery, y as sanitizeStatusCode, z as parseURL, e as encodePath, A as decodePath, B as isScriptProtocol, C as defu, D as parseQuery, E as withTrailingSlash, F as withoutTrailingSlash } from '../_/nitro.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
function mergeReactiveObjects(target, patchToApply) {
	...
	for (const key in patchToApply) {
		...
		if (isPlainObject(targetValue) && isPlainObject(subPatch) && target.hasOwnProperty(key) && !(0, vue_demi_exports.isRef)(subPatch) && !(0, vue_demi_exports.isReactive)(subPatch)) target[key] = mergeReactiveObjects(targetValue, subPatch);
...
var useAuthStore = defineStore("auth", {
	...
	actions: {
		...
		hydrateUserFromToken() {
			...
			const id = typeof payload.sub === "string" ? payload.sub : typeof payload.id === "string" ? payload.id : void 0;
...
var sensitiveMatcher = /* @__PURE__ */ (() => {
	const $0 = { prerender: true }, $1 = { ssr: false }, $2 = {
		__proto__: null,
		"": {
			__proto__: null,
			"": [$0]
...
var namedMiddleware = {
	admin: () => import('../build/admin-Bf6aZ11Q.mjs'),
	auth: () => import('../build/auth-wAiBwre-.mjs')
};
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	...
	},
	{
		...
		meta: { "middleware": ["auth", "admin"] },
		component: () => import('../build/manual-payments-DhUUjaXt.mjs')
	},
	{
		name: "admin-packages",
		path: "/admin/packages",
	...
	},
	{
		...
		path: "/admin/users",
		meta: { "middleware": ["auth", "admin"] },
		component: () => import('../build/users-CKzTmiQb.mjs')
	},
	{
		name: "auth-login",
		path: "/auth/login",
		component: () => import('../build/login-DPD1sxlx.mjs')
	},
	{
		name: "auth-register",
		path: "/auth/register",
		component: () => import('../build/register-aW7QQ-cq.mjs')
	},
	{
	...
	},
	{
		...
		meta: { "middleware": "auth" },
		component: () => import('../build/certificate-CPU2FhaI.mjs')
	},
	{
		name: "dashboard-directory",
		path: "/dashboard/directory",
		meta: { "middleware": "auth" },
		component: () => import('../build/directory-DHPJ2h7X.mjs')
	},
	{
		name: "dashboard-invoice",
		path: "/dashboard/invoice",
		meta: { "middleware": "auth" },
		component: () => import('../build/invoice-DG_qzHar.mjs')
	},
	{
		name: "dashboard-payment",
		path: "/dashboard/payment",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-_06GCMof.mjs')
	},
	{
		name: "dashboard-payment-manual",
		path: "/dashboard/payment-manual",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-manual-DYSEXEQe.mjs')
	},
	{
		name: "dashboard-payment-qr",
		path: "/dashboard/payment-qr",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-qr-BmJvucYU.mjs')
	},
	{
		name: "dashboard-payment-status",
		path: "/dashboard/payment-status",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-status-DaCNppxx.mjs')
	},
	{
		name: "dashboard-profile",
		path: "/dashboard/profile",
		meta: { "middleware": "auth" },
		component: () => import('../build/profile-BM46NvNK.mjs')
	},
	{
		name: "dashboard-schedule",
		path: "/dashboard/schedule",
		meta: { "middleware": "auth" },
		component: () => import('../build/schedule-R4-LeaKG.mjs')
	},
	{
		name: "dashboard-security",
		path: "/dashboard/security",
		meta: { "middleware": "auth" },
		component: () => import('../build/security-B80hXke0.mjs')
	},
	{
		name: "dashboard-ticket",
		path: "/dashboard/ticket",
		meta: { "middleware": "auth" },
		component: () => import('../build/ticket-D0-EtbYE.mjs')
	},
	{
		name: "register-delegate",
		path: "/register/delegate",
		meta: { "middleware": "auth" },
		component: () => import('../build/delegate-Cu_RB2Xk.mjs')
	},
	{
	...
	},
	{
		name: "about",
		path: "/about",
		component: () => import('../build/about-BcRd94SV.mjs')
	},
	{
		name: "business-matching",
		path: "/business-matching",
		meta: { "middleware": "auth" },
		component: () => import('../build/business-matching-v_l0u_R3.mjs')
	},
	{
		name: "code-of-conduct",
		path: "/code-of-conduct",
		component: () => import('../build/code-of-conduct-BJ2oihSU.mjs')
	},
	{
		name: "contact",
		path: "/contact",
		component: () => import('../build/contact-DwmRSKIU.mjs')
	},
	{
		name: "dashboard",
		path: "/dashboard",
	...
	},
	{
		name: "deal-room",
		path: "/deal-room",
		component: () => import('../build/deal-room-C1z6Rdtb.mjs')
	},
	{
		name: "directory-consent",
		path: "/directory-consent",
		component: () => import('../build/directory-consent-Ctyz_gPw.mjs')
	},
	{
		name: "exhibition",
		path: "/exhibition",
		component: () => import('../build/exhibition-BtEiRAbo.mjs')
	},
	{
		name: "faq",
		path: "/faq",
		component: () => import('../build/faq-CyPPjTLp.mjs')
	},
	{
		name: "participants",
		path: "/participants",
		component: () => import('../build/participants-DMhu7NWm.mjs')
	},
	{
		name: "partners",
		path: "/partners",
		component: () => import('../build/partners-C_Kz094J.mjs')
	},
	{
		name: "privacy",
		path: "/privacy",
		component: () => import('../build/privacy-CB-7njG1.mjs')
	},
	{
		name: "program",
		path: "/program",
	...
	},
	{
		name: "refund-policy",
		path: "/refund-policy",
		component: () => import('../build/refund-policy-XfT8-Evq.mjs')
	},
	{
		name: "register",
		path: "/register",
		component: () => import('../build/register-DWvA-OW2.mjs')
	},
	{
		name: "speakers",
		path: "/speakers",
	...
	},
	{
		name: "terms",
		path: "/terms",
		component: () => import('../build/terms-DGHP4_zX.mjs')
	},
	{
		name: "tickets",
		path: "/tickets",
		component: () => import('../build/tickets-3WSdR6od.mjs')
	},
	{
		name: "workshops",
		path: "/workshops",
	...
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-BYa-Z6b-.mjs')
	}
];
//#endregion
...
function useApi() {
	...
	const buildAuthHeaders = (headers) => {
		...
		if (authStore.accessToken) nextHeaders.set("Authorization", `Bearer ${authStore.accessToken}`);
		return nextHeaders;
	};
		...
		async onResponseError({ request, response, options }) {
			if (response.status === 401 && authStore.refreshToken && request !== "/auth/refresh") {
				...
				if (await refreshPromise) {
					...
					return $fetch$2(request, retryOptions);
				}
			}
...
//#endregion
//#region app/composables/useRegistrationFlow.ts
var normalizeStatus = (item) => {
...
function useRegistrationFlow() {
	...
	const authStore = useAuthStore();
	const state = useState("registration-flow-state", () => null);
	...
	const primeFlow = (snapshot) => {
		state.value = snapshot;
		loaded.value = true;
		error.value = "";
		const snapshotUser = snapshot.user;
		if (snapshotUser && typeof snapshotUser === "object") {
			authStore.setUser(snapshotUser);
			authStore.hydrateUserFromToken();
		}
	};
	const statusFor = (type) => normalizeStatus(state.value?.purchase_tracking?.[type]);
	const delegateStatus = computed(() => statusFor("delegate"));
	const exhibitorStatus = computed(() => statusFor("exhibitor"));
	const selectedTypes = computed(() => {
		const explicit = (state.value?.selected_types || []).filter((type) => type === "delegate" || type === "exhibitor");
		const tracked = ["delegate", "exhibitor"].filter((type) => statusFor(type) !== "not_selected");
		return [.../* @__PURE__ */ new Set([...explicit, ...tracked])];
	});
	...
	const profilePendingType = computed(() => selectedTypes.value.find((type) => statusFor(type) === "paid_profile_incomplete") || null);
	...
	const orderMatchesType = (order, type) => {
		if (!type) return true;
		if (order.product_type === type) return true;
		const items = Array.isArray(order.items) ? order.items : [];
		if (!items.length) return true;
		return items.some((item) => item.product_type === type || item.product?.product_type === type);
	};
	const activeOrder = computed(() => {
		const matching = (Array.isArray(state.value?.orders) ? state.value.orders : []).filter((order) => orderMatchesType(order, primaryType.value));
		return matching.find((order) => [
			"pending",
			"draft",
			"payment_pending"
		].includes(order.status?.toLowerCase() || "")) || matching[0] || null;
	});
	...
	const loadFlow = async (force = false) => {
		...
		error.value = "";
		try {
			const meData = (await api("/auth/me")).data;
			const user = meData.user || meData;
			authStore.setUser(user);
			authStore.hydrateUserFromToken();
			const userId = typeof user.id === "string" ? user.id : "";
			if (!userId) throw new Error("User ID was not returned by the backend.");
			const detail = await api(`/auth/users/${encodeURIComponent(userId)}`);
			state.value = detail.data;
			const detailUser = detail.data.user;
			if (detailUser && typeof detailUser === "object") {
				authStore.setUser(detailUser);
				authStore.hydrateUserFromToken();
			}
			loaded.value = true;
			return state.value;
		} catch (cause) {
			error.value = cause.data?.message || (cause instanceof Error ? cause.message : "Registration progress could not be loaded.");
			throw cause;
		} finally {
			loading.value = false;
		}
...
function useAuth() {
	...
	const register = async (payload) => {
		...
		if (result.success) await registrationFlow.loadFlow(true);
		return result;
	};
	const logout = async () => {
		try {
	...
	const changePassword = (payload) => api("/auth/password", {
		method: "PUT",
		body: payload
	});
	return {
	...
	setup(__props) {
		...
		const hasDelegatePackageSelected = computed(() => {
			...
			return [
				...
				"paid_profile_incomplete",
				"completed"
			].includes(registrationFlow.delegateStatus.value);
		});
		const primaryNav = computed(() => [
			...
			},
			{
				...
				disabled: hasDelegatePackageSelected.value
			}
		]);
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_NuxtLink, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						key: 1,
						class: "brand-fallback text-sm font-black"
					}, "IWBIF"))]), createVNode("span", { class: "hidden sm:block" }, [createVNode("span", { class: "brand-kicker block whitespace-nowrap text-[10px] uppercase tracking-[0.35em] text-amber-200/75" }, "IWAPI presents"), createVNode("span", { class: "brand-name block whitespace-nowrap text-base font-semibold tracking-[0.08em] text-white" }, "IWBIF 2026")])];
				}),
				_: 1
			}, _parent));
			...
			ssrRenderList(unref(primaryNav), (item) => {
				_push(ssrRenderComponent(_component_NuxtLink, {
					key: item.to,
					to: item.to,
					class: [item.disabled ? "pointer-events-none cursor-not-allowed opacity-50" : "hover:bg-white/5 hover:text-white", "nav-link inline-flex items-center whitespace-nowrap rounded-full px-3 py-2 uppercase tracking-[0.12em] text-[11px] leading-none"],
					onClick: ($event) => item.disabled ? $event.preventDefault() : closeMenus()
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
			...
			if (unref(isAuthenticated) && !unref(isRegistrationPaid)) _push(ssrRenderComponent(_component_NuxtLink, {
				to: unref(paymentCtaTo),
				class: "header-cta whitespace-nowrap rounded-full bg-gradient-to-r from-amber-300 to-amber-200 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-950 shadow-lg shadow-amber-500/20 transition hover:brightness-110 sm:px-5"
			}, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`${ssrInterpolate(unref(ctaLabel))}`);
					else return [createTextVNode(toDisplayString(unref(ctaLabel)), 1)];
				}),
				_: 1
			}, _parent));
			else _push(`<!---->`);
			...
			ssrRenderList(unref(allNav), (item) => {
				_push(ssrRenderComponent(_component_NuxtLink, {
					key: item.to,
					to: item.to,
					class: [item.disabled ? "pointer-events-none cursor-not-allowed opacity-50" : "hover:bg-white/5 hover:text-white", "rounded-xl px-4 py-3 text-sm text-slate-200 transition"],
					onClick: ($event) => item.disabled ? $event.preventDefault() : closeMenus()
				}, {
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`${ssrInterpolate(item.label)}`);
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-DmYxM9EK.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-w3aim4WE.mjs'));
