...
import { i as createError, p as parseURL, e as encodePath, n as decodePath, w as withQuery, o as hasProtocol, q as isScriptProtocol, l as joinURL, v as sanitizeStatusCode, x as parseQuery, y as withTrailingSlash, z as withoutTrailingSlash, $ as $fetch, A as defu } from '../_/nitro.mjs';
...
var namedMiddleware = { auth: () => import('../build/auth-DUEOzcUo.mjs') };
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		component: () => import('../build/speakers-CzSMSq2V.mjs')
	},
	{
		name: "auth-login",
		path: "/auth/login",
		component: () => import('../build/login-Bxnd1r2z.mjs')
	},
	{
		name: "dashboard-announcements",
		path: "/dashboard/announcements",
		meta: { "middleware": "auth" },
		component: () => import('../build/announcements-Byj3ZVFm.mjs')
	},
	{
		name: "dashboard-certificate",
		path: "/dashboard/certificate",
		meta: { "middleware": "auth" },
		component: () => import('../build/certificate-CrFS0PLB.mjs')
	},
	{
		name: "dashboard-directory",
		path: "/dashboard/directory",
		meta: { "middleware": "auth" },
		component: () => import('../build/directory-Bfvnxixn.mjs')
	},
	{
		name: "dashboard-invoice",
		path: "/dashboard/invoice",
		meta: { "middleware": "auth" },
		component: () => import('../build/invoice-URqIsKA4.mjs')
	},
	{
		name: "dashboard-payment",
		path: "/dashboard/payment",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-BgkF3n1L.mjs')
	},
	{
		name: "dashboard-payment-status",
		path: "/dashboard/payment-status",
		meta: { "middleware": "auth" },
		component: () => import('../build/payment-status-DxGUtF9_.mjs')
	},
	{
		name: "dashboard-profile",
		path: "/dashboard/profile",
		meta: { "middleware": "auth" },
		component: () => import('../build/profile-C4nIoew7.mjs')
	},
	{
		name: "dashboard-schedule",
		path: "/dashboard/schedule",
		meta: { "middleware": "auth" },
		component: () => import('../build/schedule-8sN7Y3q-.mjs')
	},
	{
		name: "dashboard-ticket",
		path: "/dashboard/ticket",
		meta: { "middleware": "auth" },
		component: () => import('../build/ticket-BqMWUhHm.mjs')
	},
	{
		name: "about",
		path: "/about",
		component: () => import('../build/about-Dy4-ABaE.mjs')
	},
	{
		name: "code-of-conduct",
		path: "/code-of-conduct",
		component: () => import('../build/code-of-conduct-DP8PkPrE.mjs')
	},
	{
		name: "dashboard",
		path: "/dashboard",
		meta: { "middleware": "auth" },
		component: () => import('../build/dashboard-oQBmMDI0.mjs')
	},
	{
		name: "directory-consent",
		path: "/directory-consent",
		component: () => import('../build/directory-consent-FAyjdFlm.mjs')
	},
	{
		name: "faq",
		path: "/faq",
		component: () => import('../build/faq-B7Vp3vT1.mjs')
	},
	{
		name: "partners",
		path: "/partners",
		component: () => import('../build/partners-D1y7h-9k.mjs')
	},
	{
		name: "privacy",
		path: "/privacy",
		component: () => import('../build/privacy-CSUzO6eW.mjs')
	},
	{
		name: "program",
		path: "/program",
		component: () => import('../build/program-D32u3Cz1.mjs')
	},
	{
		name: "refund-policy",
		path: "/refund-policy",
		component: () => import('../build/refund-policy-BSG4V8RA.mjs')
	},
	{
		name: "register",
		path: "/register",
		meta: { "middleware": "auth" },
		component: () => import('../build/register-CBri3I9a.mjs')
	},
	{
		name: "speakers",
		path: "/speakers",
		component: () => import('../build/speakers-R-_AxKze.mjs')
	},
	{
		name: "terms",
		path: "/terms",
		component: () => import('../build/terms-BA29PLkf.mjs')
	},
	{
		name: "tickets",
		path: "/tickets",
		component: () => import('../build/tickets-jBdnlKKB.mjs')
	},
	{
		name: "workshops",
		path: "/workshops",
		component: () => import('../build/workshops-FMYXQaVo.mjs')
	},
	{
		name: "index",
		path: "/",
		component: () => import('../build/pages-BcVb8uYk.mjs')
	}
];
//#endregion
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_component_NuxtLink, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-cyan-400/30 bg-cyan-400/10 text-sm font-bold text-cyan-200"${_scopeId}> AI </span><span class="hidden sm:block"${_scopeId}><span class="block whitespace-nowrap text-[10px] uppercase tracking-[0.35em] text-cyan-200/70"${_scopeId}>ASEAN Event Portal</span><span class="block whitespace-nowrap text-base font-semibold text-white"${_scopeId}>ASEAN AI for Education</span></span>`);
					else return [createVNode("span", { class: "flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-cyan-400/30 bg-cyan-400/10 text-sm font-bold text-cyan-200" }, " AI "), createVNode("span", { class: "hidden sm:block" }, [createVNode("span", { class: "block whitespace-nowrap text-[10px] uppercase tracking-[0.35em] text-cyan-200/70" }, "ASEAN Event Portal"), createVNode("span", { class: "block whitespace-nowrap text-base font-semibold text-white" }, "ASEAN AI for Education")])];
				}),
				_: 1
			}, _parent));
			...
			_push(`</main><footer class="relative z-10 border-t border-white/10 bg-slate-950/60"><div class="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-3 lg:px-8"><div><p class="text-xs uppercase tracking-[0.3em] text-cyan-200">ASEAN AI for Education</p><p class="mt-3 max-w-sm text-sm leading-7 text-slate-400">Building intelligent solutions for the future of education across Southeast Asia.</p></div><div class="grid grid-cols-2 gap-3 text-sm text-slate-300">`);
			_push(ssrRenderComponent(_component_NuxtLink, { to: "/about" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Tentang`);
					else return [createTextVNode("Tentang")];
				}),
				_: 1
			}, _parent));
			...
			_push(ssrRenderComponent(_component_NuxtLink, { to: "/speakers" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Pembicara`);
					else return [createTextVNode("Pembicara")];
				}),
				_: 1
			}, _parent));
			_push(ssrRenderComponent(_component_NuxtLink, { to: "/workshops" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Workshop`);
					else return [createTextVNode("Workshop")];
				}),
				_: 1
			}, _parent));
			_push(ssrRenderComponent(_component_NuxtLink, { to: "/partners" }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`Mitra`);
					else return [createTextVNode("Mitra")];
				}),
				_: 1
			}, _parent));
			...
			_push(`</div><div class="text-sm text-slate-400 md:text-right"><p>Informasi: info@aseanaiedu.com</p><p class="mt-1">Registrasi: registration@aseanaiedu.com</p><div class="mt-3 flex flex-wrap gap-4 md:justify-end">`);
			...
			_push(`</div></div></div><p class="border-t border-white/10 px-4 py-5 text-center text-xs text-slate-500">© 2026 ASEAN AI for Education Summit. All rights reserved.</p></footer></div>`);
		};
	}
});
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-D0cL_70U.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-mGfomk4j.mjs'));
...
export { NuxtLink as N, useSeoMeta$1 as a, useAsyncData as b, useNuxtApp as c, defineNuxtRouteMiddleware as d, useRoute as e, useRuntimeConfig as f, useHead$1 as g, entry as h, navigateTo as n, useAuthStore as u };;globalThis.__timing__.logEnd('Load chunks/virtual/entry');
