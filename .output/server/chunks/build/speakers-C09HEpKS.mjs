globalThis.__timing__.logStart('Load chunks/build/speakers-C09HEpKS');import { c as useNuxtApp, b as useAsyncData } from '../virtual/entry.mjs';
...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	async setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8" }, _attrs))}><p class="text-sm uppercase tracking-[0.3em] text-cyan-200/70">Speakers</p><div class="mt-3 flex items-end justify-between gap-4"><h1 class="text-4xl font-black text-white">Featured Speakers &amp; Ecosystem Leaders</h1><span class="rounded-full border border-white-15 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.25em] text-slate-200">${ssrInterpolate(unref(loading) ? "Loading..." : `${unref(displayItems).length} speakers`)}</span></div>`);
			if (unref(loading)) {
...
export { speakers_default as default };;globalThis.__timing__.logEnd('Load chunks/build/speakers-C09HEpKS');
//# sourceMappingURL=speakers-C09HEpKS.mjs.map
