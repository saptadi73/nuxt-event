globalThis.__timing__.logStart('Load chunks/build/announcements-Byj3ZVFm');import { a as useSeoMeta$1 } from '../virtual/entry.mjs';
...
var announcements_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		useSeoMeta$1({ title: "Announcements | ASEAN AI for Education" });
		const items = [
			{
				type: "Preparation",
				date: "1 August 2026",
				title: "Prepare your development environment",
				text: "Bring your laptop, charger, GitHub account, preferred editor, and personal internet device. Track-specific requirements will be shared before the event."
			},
			{
				type: "Profile",
				date: "1 August 2026",
				title: "Complete your professional profile",
				text: "Add expertise, AI interests, and collaboration goals to improve participant recommendations and team formation."
			},
			{
				type: "Security",
				date: "1 August 2026",
				title: "Keep your QR code private",
				text: "Your event pass belongs only to you. Save an offline screenshot for check-in, but never share it with another person."
			}
		];
...
export { announcements_default as default };;globalThis.__timing__.logEnd('Load chunks/build/announcements-Byj3ZVFm');
//# sourceMappingURL=announcements-Byj3ZVFm.mjs.map
