globalThis.__timing__.logStart('Load chunks/build/certificate-DGhX1zDl');import { a as useSeoMeta$1 } from '../virtual/entry.mjs';
...
var certificate_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-4xl px-4 py-12 sm:px-6" }, _attrs))}><p class="text-sm uppercase tracking-[.35em] text-cyan-200">Digital Certificate</p><h1 class="mt-3 text-4xl font-black">Recognition for your participation</h1><div class="mt-8 overflow-hidden rounded-[2rem] border border-orange-200/20 bg-gradient-to-br from-orange-200/10 via-white/5 to-cyan-300/10 p-8 text-center sm:p-12"><p class="text-xs uppercase tracking-[.35em] text-orange-200">IWBIF 2026</p><h2 class="mt-8 text-4xl font-black">Certificate of Participation</h2><p class="mx-auto mt-5 max-w-xl leading-7 text-slate-300">Certificates are available after attendance verification and required profile completion.</p><div class="mx-auto mt-8 max-w-lg border-t border-white/15 pt-5 text-sm text-slate-400">14-17 October 2026 · Hotel Kempinski Indonesia, Jakarta</div><button disabled class="mt-8 cursor-not-allowed rounded-full border border-white/15 px-6 py-3 font-semibold text-slate-500">Certificate not yet available</button></div></section>`);
		};
	}
});
//#endregion
...
export { certificate_default as default };;globalThis.__timing__.logEnd('Load chunks/build/certificate-DGhX1zDl');
//# sourceMappingURL=certificate-DGhX1zDl.mjs.map
