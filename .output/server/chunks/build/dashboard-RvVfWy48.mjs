...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "dashboard-shell mx-auto max-w-7xl px-3 py-10 sm:px-6 lg:px-8" }, _attrs))} data-v-a7a68d2d><p class="text-sm uppercase tracking-[.35em] text-cyan-200" data-v-a7a68d2d>${ssrInterpolate(unref(canViewSalesReport) ? "Organizer Dashboard" : "Participant Dashboard")}</p><div class="mt-3 flex flex-wrap items-end justify-between gap-5" data-v-a7a68d2d><div data-v-a7a68d2d><h1 class="text-3xl font-black sm:text-4xl" data-v-a7a68d2d>Welcome to IWBIF 2026</h1><p class="mt-3 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base" data-v-a7a68d2d>Your ticket, schedule, profile, networking, payment, and event updates in one place.</p></div><div class="glass-card rounded-2xl px-4 py-3 text-left sm:text-right" data-v-a7a68d2d><p class="text-[10px] uppercase tracking-[.25em] text-slate-400 sm:text-xs" data-v-a7a68d2d>Event starts in</p><p class="mt-1 text-lg font-bold text-cyan-200 sm:text-xl" data-v-a7a68d2d>${ssrInterpolate(unref(countdown))}</p></div></div><div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4" data-v-a7a68d2d><!--[-->`);
			ssrRenderList(statuses, (status) => {
				_push(`<article class="glass-card rounded-3xl p-5" data-v-a7a68d2d><p class="text-xs uppercase tracking-[.2em] text-slate-400" data-v-a7a68d2d>${ssrInterpolate(status.label)}</p><p class="mt-3 text-xl font-bold" data-v-a7a68d2d>${ssrInterpolate(status.value)}</p><p class="mt-2 text-sm text-slate-400" data-v-a7a68d2d>${ssrInterpolate(status.note)}</p></article>`);
			});
			_push(`<!--]--></div>`);
			if (unref(canViewSalesReport)) {
				_push(`<div class="mt-8 rounded-3xl border border-amber-300/30 bg-amber-300/10 p-5 sm:p-6" data-v-a7a68d2d><div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between" data-v-a7a68d2d><div data-v-a7a68d2d><p class="text-xs uppercase tracking-[.25em] text-amber-200" data-v-a7a68d2d>Organizer view</p><h2 class="mt-2 text-2xl font-bold" data-v-a7a68d2d>Ticket sales &amp; revenue report</h2></div><div class="flex flex-wrap gap-3" data-v-a7a68d2d>`);
			...
			_push(`<h2 class="mt-10 text-2xl font-bold" data-v-a7a68d2d>Quick access</h2><div class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3" data-v-a7a68d2d><!--[-->`);
			ssrRenderList(menu, (item) => {
				_push(ssrRenderComponent(_component_NuxtLink, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<p class="text-xs uppercase tracking-[.25em] text-cyan-200" data-v-a7a68d2d${_scopeId}>${ssrInterpolate(item.label)}</p><h3 class="mt-3 text-xl font-bold" data-v-a7a68d2d${_scopeId}>${ssrInterpolate(item.title)}</h3><p class="mt-2 text-sm leading-6 text-slate-400" data-v-a7a68d2d${_scopeId}>${ssrInterpolate(item.text)}</p>`);
						else return [
...
var dashboard_default = /*#__PURE__*/ _plugin_vue_export_helper_default(index_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-a7a68d2d"]]);

export { dashboard_default as default };
//# sourceMappingURL=dashboard-RvVfWy48.mjs.map
