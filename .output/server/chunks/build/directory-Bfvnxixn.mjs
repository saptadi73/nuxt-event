globalThis.__timing__.logStart('Load chunks/build/directory-Bfvnxixn');import { a as useSeoMeta$1, b as useAsyncData } from '../virtual/entry.mjs';
...
var directory_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	async setup(__props) {
		...
		useSeoMeta$1({ title: "Participant Directory | ASEAN AI for Education" });
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8" }, _attrs))}><p class="text-sm uppercase tracking-[.35em] text-cyan-200">Participant Directory</p><h1 class="mt-3 text-4xl font-black">Connect With ASEAN AI Professionals</h1><p class="mt-3 max-w-3xl leading-7 text-slate-300">Find collaborators, mentors, technical experts, and members of your workshop community. Private contact information is never displayed.</p><div class="mt-8"><label><span class="sr-only">Search participants</span><input${ssrRenderAttr("value", unref(query))} type="search" placeholder="Search name, organization, or biography" class="w-full rounded-2xl border border-white/10 bg-white/5 px-5 py-4 outline-none focus:border-cyan-300"></label></div>`);
			if (unref(pending)) {
...
export { directory_default as default };;globalThis.__timing__.logEnd('Load chunks/build/directory-Bfvnxixn');
//# sourceMappingURL=directory-Bfvnxixn.mjs.map
