globalThis.__timing__.logStart('Load chunks/build/payment-c62Y_uqA');import { a as useSeoMeta$1, N as NuxtLink } from '../virtual/entry.mjs';
...
var payment_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8" }, _attrs))}><div class="glass-card rounded-[2rem] p-6"><p class="text-sm uppercase tracking-[.3em] text-amber-200">DOKU Checkout</p><h1 class="mt-3 text-4xl font-bold">Secure payment</h1><p class="mt-3 text-slate-300">Continue to DOKU&#39;s secure checkout. The final amount is determined by the backend from your delegate package.</p>`);
			if (unref(checking)) _push(`<div class="mt-8 text-slate-300">Checking your registration and payment status…</div>`);
			else if (unref(paid)) {
				_push(`<div class="mt-8 rounded-2xl border border-emerald-300/20 bg-emerald-300/5 p-5"><p class="text-lg font-semibold text-emerald-300">Payment received</p><p class="mt-2 text-slate-300">Payment is complete. Organizer confirmation of your registration is handled separately.</p>`);
...
export { payment_default as default };;globalThis.__timing__.logEnd('Load chunks/build/payment-c62Y_uqA');
//# sourceMappingURL=payment-c62Y_uqA.mjs.map
