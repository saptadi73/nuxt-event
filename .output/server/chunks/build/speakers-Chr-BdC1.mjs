globalThis.__timing__.logStart('Load chunks/build/speakers-Chr-BdC1');import { a as useSeoMeta$1, b as useAsyncData, c as useNuxtApp } from '../virtual/entry.mjs';
...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	async setup(__props) {
		...
		useSeoMeta$1({ title: "Manage Speaker Photos | ASEAN AI for Education" });
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8" }, _attrs))}><p class="text-sm uppercase tracking-[.35em] text-cyan-200">Admin</p><h1 class="mt-3 text-4xl font-black">Manage Speaker Photos</h1><p class="mt-3 text-slate-300">Upload a JPG, PNG, or WebP profile photo (maximum 5 MB) for each speaker.</p>`);
			if (unref(pending)) {
...
export { speakers_default as default };;globalThis.__timing__.logEnd('Load chunks/build/speakers-Chr-BdC1');
//# sourceMappingURL=speakers-Chr-BdC1.mjs.map
