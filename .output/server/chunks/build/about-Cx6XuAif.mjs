globalThis.__timing__.logStart('Load chunks/build/about-Cx6XuAif');import { a as useSeoMeta$1 } from '../virtual/entry.mjs';
...
var about_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		useSeoMeta$1({
			title: "About | ASEAN AI for Education Summit",
			description: "Mission, impact, and community of the ASEAN AI for Education Summit."
		});
		const values = [
			{
				label: "Vision",
...
export { about_default as default };;globalThis.__timing__.logEnd('Load chunks/build/about-Cx6XuAif');
//# sourceMappingURL=about-Cx6XuAif.mjs.map
