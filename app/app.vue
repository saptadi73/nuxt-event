      ...
      <div class="mx-auto flex w-full max-w-[1440px] items-center gap-5 px-4 py-3 sm:px-6 lg:px-8">
        <NuxtLink to="/" class="flex min-w-0 shrink-0 items-center gap-3">
          ...
          <span class="hidden sm:block">
            <span class="block whitespace-nowrap text-[10px] uppercase tracking-[0.35em] text-amber-200/70">IWAPI presents</span>
            <span class="block whitespace-nowrap text-base font-semibold text-white">IWBIF 2026</span>
          </span>
        </NuxtLink>
