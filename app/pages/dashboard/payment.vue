  ...
  <section class="mx-auto max-w-6xl px-3 py-10 sm:px-6">
    <div class="glass-card rounded-[2rem] p-4 sm:p-7">
      ...
      <template v-else>
        ...
        <NuxtLink v-if="isPaid" :to="paidDestination" class="mt-6 inline-flex rounded-full bg-emerald-300 px-6 py-3 text-center font-bold text-slate-950">{{ paidActionLabel }}</NuxtLink>
