...
const requestPayment=()=>{if(!orderId.value||submitting.value||paymentDisabled.value)return;if(paymentApi.isDokuProvider){dokuModalOpen.value=true;return;}if(showSplitNotice.value){splitModalOpen.value=true;return;}void startPayment();};
