...
@media(max-width:640px){.notification-page{padding-top:1.5rem}.section-tabs{grid-template-columns:1fr}.section-tabs small{display:block}.template-list{grid-template-columns:1fr}.test-card form{min-width:100%;flex-direction:column}.preference-row{grid-template-columns:1fr}.history-summary{grid-template-columns:1fr}.event-picker{width:100%}}
</style>
