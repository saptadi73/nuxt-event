      ...
      <section v-else class="section-content">
        ...
        <div class="glass-card history-table">
          <div class="history-tools">
            <label class="field history-search"><span>Cari riwayat</span><input v-model.trim="historySearch" type="search" placeholder="Penerima, subjek, jenis email, atau pesan error"></label>
            <label class="field"><span>Status</span><select v-model="historyStatus"><option value="">Semua status</option><option value="sent">Berhasil</option><option value="failed">Gagal</option><option value="pending">Menunggu</option></select></label>
...
.history-tools{display:grid;grid-template-columns:minmax(16rem,1fr) 12rem 10rem;gap:.75rem;padding:1rem 1.25rem;border-bottom:1px solid #ffffff10}.history-pagination{display:flex;align-items:center;justify-content:space-between;gap:1rem;border-top:1px solid #ffffff10;padding:1rem 1.25rem;font-size:.78rem;color:#94a3b8}.history-pagination>div{display:flex;align-items:center;gap:.75rem}.history-pagination .secondary{padding:.55rem .85rem}
@media(max-width:900px){.template-layout,.account-grid{grid-template-columns:1fr}.template-list{display:grid;grid-template-columns:repeat(2,1fr)}.list-title,.loading-copy{grid-column:1/-1}.user-results{max-height:22rem}.section-tabs small{display:none}.history-tools{grid-template-columns:1fr 1fr}.history-search{grid-column:1/-1}}
@media(max-width:640px){
  ...
  .history-tools{grid-template-columns:1fr}.history-search{grid-column:auto}
  .history-pagination,.history-pagination>div{align-items:stretch;flex-direction:column}
