<template>
  <section class="mt-7 rounded-2xl border border-white/10 bg-white/5 p-5">
    ...
    <div v-if="feedback" :role="feedbackTone === 'error' ? 'alert' : 'status'" class="mt-4 rounded-xl border p-3 text-sm" :class="feedbackTone === 'success' ? 'border-emerald-300/30 bg-emerald-950/30 text-emerald-100' : 'border-red-400/30 bg-red-950/30 text-red-100'">{{ feedback }}</div>
